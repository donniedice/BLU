...
function BLU.CreateGeneralPanel(panel)
    ...
    -- Header
    local header = BLU.Design:CreateHeader(content, "General Settings", "Interface\\Icons\\INV_Misc_Gear_01")
    ...
    welcomeCheck:SetPoint("TOPLEFT", enableCheck, "BOTTOMLEFT", 0, -10)
    ...
    debugCheck:SetPoint("TOPLEFT", welcomeCheck, "BOTTOMLEFT", 0, -10)
    ...
    showNamesCheck:SetPoint("TOPLEFT", debugCheck, "BOTTOMLEFT", 0, -10)
    ...
    audioSection:SetPoint("TOPLEFT", coreSection, "BOTTOMLEFT", 0, -20)
    audioSection:SetPoint("RIGHT", -20, 0)
    audioSection:SetHeight(200)
    
    -- Volume slider
    local volumeLabel = audioSection.content:CreateFontString(nil, "OVERLAY", "GameFontNormal")
    volumeLabel:SetPoint("TOPLEFT", 0, -10)
    ...
    channelLabel:SetPoint("TOPLEFT", volumeSlider, "BOTTOMLEFT", 0, -30)
    ...
    -- Test button
    local testBtn = BLU.Design:CreateButton(audioSection.content, "Test Volume", 120, 25)
    testBtn:SetPoint("LEFT", channelDropdown, "RIGHT", 20, 2)
    ...
    behaviorSection:SetPoint("TOPLEFT", audioSection, "BOTTOMLEFT", 0, -20)
    behaviorSection:SetPoint("RIGHT", -20, 0)
    behaviorSection:SetHeight(150)
    ...
    randomCheck:SetPoint("TOPLEFT", 0, -10)
    ...
    muteCheck:SetPoint("TOPLEFT", randomCheck, "BOTTOMLEFT", 0, -10)
    ...
    combatCheck:SetPoint("TOPLEFT", muteCheck, "BOTTOMLEFT", 0, -10)
    ...
    actionsSection:SetPoint("TOPLEFT", behaviorSection, "BOTTOMLEFT", 0, -20)
    actionsSection:SetPoint("RIGHT", -20, 0)
    actionsSection:SetHeight(80)
    
    -- Reset button
    local resetBtn = BLU.Design:CreateButton(actionsSection.content, "Reset to Defaults", 150, 30)
    resetBtn:SetPoint("LEFT", 20, 0)
    resetBtn:SetScript("OnClick", function()
        StaticPopup_Show("BLU_RESET_CONFIRM")
    end)
    
    -- Reload UI button
    local reloadBtn = BLU.Design:CreateButton(actionsSection.content, "Reload UI", 100, 30)
    reloadBtn:SetPoint("LEFT", resetBtn, "RIGHT", 20, 0)
    reloadBtn:SetScript("OnClick", function()
        ReloadUI()
    end)
    
    -- Test all sounds button
    local testAllBtn = BLU.Design:CreateButton(actionsSection.content, "Test All Sounds", 130, 30)
    testAllBtn:SetPoint("LEFT", reloadBtn, "RIGHT", 20, 0)
